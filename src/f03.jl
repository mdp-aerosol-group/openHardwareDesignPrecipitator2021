...
PJ_palette_paper =
    [colorant"rgb(0, 0, 139)" colorant"rgb(204,204,0)" colorant"rgb(0,0,138)" colorant"rgb(203,203,0)" colorant"rgb(0,0,137)" colorant"rgb(202,202,0)"]
...
img = PNG("Figures/f03.png", dpi = 600, 3.25inch, 2inch);
draw(img, cut)
